...
output=$(run_claude "In the brainstorming skill, is database design required for Spring Boot projects? What must be included?" 30)
...
output=$(run_claude "What audit fields must be included in database tables according to the brainstorming skill?" 30)
...
output=$(run_claude "Where does brainstorming save the design document? What is the file path pattern?" 30)
...
output=$(run_claude "In brainstorming, after claiming to create a document, what must be done to verify it exists?" 30)
...
output=$(run_claude "Does brainstorming use a subagent to review the design document? What does the spec-document-reviewer check?" 30)
...
output=$(run_claude "What are the main output files produced by brainstorming? What does each contain?" 30)
