...
output=$(run_claude "Does the subagent-driven-development skill require implementers to do self-review before reporting completion? What should they check?" 30)
...
output=$(run_claude "What is the spec compliance reviewer's attitude toward the implementer's report in subagent-driven-development? Should they trust the report?" 30)
...
output=$(run_claude "What are the prerequisites before using subagent-driven-development? Is worktree required?" 30)
...
output=$(run_claude "In subagent-driven-development, how does the controller provide task information to implementer subagents? Does it make them read a file or provide text directly?" 30)
