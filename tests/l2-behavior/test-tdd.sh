...
output=$(run_claude "What is the RED-GREEN-REFACTOR cycle in test-driven-development? What order must these phases be followed?" 60)
...
output=$(run_claude "In test-driven-development, can I write implementation code before writing tests? What does the skill say about this?" 60)
...
output=$(run_claude "After writing a test in TDD, what must happen before writing implementation? What should the test do?" 60)
...
output=$(run_claude "In test-driven-development, how much code should I write to make a test pass? What is the minimal implementation principle?" 60)
...
output=$(run_claude "After a test passes in TDD, what happens in the REFACTOR phase? Can I skip it?" 60)
...
output=$(run_claude "Is test-driven-development a flexible guideline or a rigid discipline? Can I adapt it to skip steps?" 60)
