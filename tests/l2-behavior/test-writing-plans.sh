...
output=$(run_claude "In writing-plans, when is the worktree created? At what step does this happen?" 30)
...
output=$(run_claude "What happens in Step 3 of writing-plans? What is confirmed or created?" 30)
...
output=$(run_claude "In writing-plans, what is the recommended time duration for each task step? How long should each step take?" 30)
...
output=$(run_claude "What is Step 4 of writing-plans? What is planned in this step?" 30)
...
output=$(run_claude "Does writing-plans use a reviewer to check the plan? What is checked?" 30)
...
output=$(run_claude "In the final step of writing-plans (Step 9), how is the execution mode chosen? What are the options?" 30)
...
output=$(run_claude "Do the tasks in writing-plans follow TDD? What are the standard steps for each task?" 30)
